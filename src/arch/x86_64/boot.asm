...
start:
    ...
    ; Check processor capabilities, and abort with an error if some are missing.
    ...
    jmp gdt64.code:long_mode_start ; Far jump to set long mode finally
...
; Long-mode GDT - http://os.phil-opp.com/entering-longmode.html#the-global-descriptor-table
section .rodata
gdt64:
    dq 0 ; zero entry
.code: equ $ - gdt64 ; new
